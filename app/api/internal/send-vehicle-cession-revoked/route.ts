import { VehicleCessionRevokedEmail } from '@/emails/VehicleCessionRevokedEmail';
...
export async function POST(request: Request) {
  ...
  const subject = `Übertragung von „${vehicleLabel}“ zurückgezogen`;
  ...
  if (error) {
    console.error('resend_send_vehicle_cession_revoked_failed', {
