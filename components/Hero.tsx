        ...
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="mt-2 text-[clamp(2.4rem,6vw,4.25rem)] font-semibold leading-[1.05] tracking-tight">
            ...
            <span className="mt-3 flex flex-wrap items-baseline justify-center gap-x-3">
              <span className="text-gradient">{t("titleAsk")}</span>
              <GarIqWordmark size="lg" variant="gradient" className="hero-wordmark shrink-0" />
            </span>
          </h1>

          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600 dark:text-slate-300 sm:text-xl sm:leading-9">
            {t("subtitleShort")}
          </p>
