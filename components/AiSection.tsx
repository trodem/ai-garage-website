      ...
      <div className="rounded-4xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-900 lg:p-12">
        <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <Reveal variant="right">
            <AiPreview
              assistant={t("preview.assistant")}
              userMessage={t("preview.userMessage")}
              answerIntro={t("preview.answerIntro")}
              eventTitle={t("preview.eventTitle")}
              fields={t.raw("preview.fields")}
              values={t.raw("preview.values")}
